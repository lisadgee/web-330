...
//Declare submitButton
let submitButton = document.getElementById("submitButton");

//onclick button that runs the showData() function when Submit button is clicked.
...
function showData() {
   ...
   //Change value of the location.href object to project09-02b.html
